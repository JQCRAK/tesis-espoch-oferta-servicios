        ...
        <>
            ...
            <div style={{
                ...
                <div style={{
                    ...
                    gap: isMobile ? 20 : isTablet ? 24 : 48,
                    padding: isMobile ? '28px 16px 24px' : '40px 20px 32px',
                }}>
                    <div style={p.heroIzq}>
                    ...
                    <div style={p.heroDer}>
                        <div style={p.buscadorBox}>
                            ...
                            <input
                                ...
                                placeholder={isMobile ? 'Buscar proyecto...' : 'Buscar por título, tecnología o especialidad...'}
            ...
            <div style={{
                ...p.pagina,
                padding: isMobile ? '16px 12px 48px' : '24px 16px 56px',
            }}>
                ...
                {tendencia && !cargando && (
                    <div style={{
                        ...p.tendBanner,
                        borderLeft: `4px solid ${tendColor}`,
                ...
                {/* Pills tecnología — scroll horizontal en móvil */}
                {pills.length > 0 && !busqueda && (
                    <div style={{ ...p.pillsArea, marginBottom: isMobile ? 14 : 18 }}>
                        <span style={{ ...p.pillsLabel, fontFamily: FONT }}>
                            <FaCode style={{ marginRight: 5, color: tendColor }} />
                            {isMobile ? 'Tecnologías:' : 'Tecnologías en tendencia:'}
                        </span>
                        <div style={{
                            ...p.pillsRow,
                            ...
                            <button className="pill-btn" onClick={() => handlePill('')}
                                style={{
                                    ...p.pill, fontFamily: FONT, flexShrink: 0,
                ...
                {cargando ? (
                    ...
                    <div style={p.empty}>
                        ...
                        <button onClick={limpiarBusqueda} style={{ ...p.btnVacioLimpiar, fontFamily: FONT }}>
