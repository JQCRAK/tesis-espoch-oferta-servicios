// frontend/src/pages/graduado/NoticiasGraduado.jsx
...
/* ── ImgBlur: fondo desenfocado + imagen nítida encima ── */
const ImgBlur = ({ url, grad, h = 200, radius = '10px 10px 0 0', children }) => (
    <div style={{
        ...
        {url
            ...
            : <div style={{ position:'absolute', inset:0, background:grad, filter:'brightness(0.55)' }} />
        }
        <div style={{
            ...
            {url
                ? <img src={url} alt="" loading="lazy" style={{
                    ...
                    borderRadius:7, boxShadow:'0 4px 24px rgba(0,0,0,0.55)',
                  }} onError={e => { e.target.style.display='none'; }} />
                : <div style={{
                    position:'absolute', inset:0, background:grad, borderRadius:radius,
                    display:'flex', alignItems:'center', justifyContent:'center',
                  }}>
...
═══════════════════════════════════════════════════════════ */
const s = {
    /* Contenedor raíz — ocupa el espacio del Outlet */
    wrap:   { minHeight:'100%', background:'var(--color-fondo-web, #f4f5f7)', fontFamily:FONT },
    cuerpo: { maxWidth:1060, margin:'0 auto', padding:'22px 20px 50px' },
    ...
    tituloPag: {
        ...
        color:'#1a1a2e', display:'flex', alignItems:'center', gap:9, fontFamily:FONT,
    },
    subtituloPag: {
        margin:0, fontSize:'0.78rem', color:'#6c757d', fontFamily:FONT,
    },
...
export default NoticiasGraduado;