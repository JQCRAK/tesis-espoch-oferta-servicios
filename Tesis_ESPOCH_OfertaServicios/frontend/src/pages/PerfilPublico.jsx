            ...
            {total === 0 ? (
                ...
                <div onMouseEnter={pausar} onMouseLeave={reanudar}>
                    ...
                    >
                        ...
                        {!isMobile && slice.length < ITEMS_POR_PAGINA && (
                            <div style={cr.ghost} />
                        )}
                    </div>
...
const PerfilPublico = () => {
    ...
    // Layout dinámico según breakpoint
    // Desktop: 3 columnas | Tablet: 2 columnas | Mobile: 1 columna apilada
    ...
    return (
        <>
            ...
            <div style={{
                ...s.page,
                padding: isMobile ? '10px 10px 32px' : '14px 16px 40px',
            }}>
                <div style={gridLayout}>
                    ...
                    <div style={s.colLeft}>
                        ...
                        {/* En tablet: especialidades van en la columna izquierda */}
                        {isTablet && graduado.afinidades?.length > 0 && (
                            <div style={s.card}>
                                <p style={{ ...s.secTit, fontFamily: FONT }}>
                    ...
                    {/* COLUMNA CENTRAL — tecnologías, proyectos, certificados */}
                    <div style={s.colMid}>
